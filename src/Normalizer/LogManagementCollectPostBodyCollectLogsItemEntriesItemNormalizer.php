...
class LogManagementCollectPostBodyCollectLogsItemEntriesItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementCollectPostBodyCollectLogsItemEntriesItem' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementCollectPostBodyCollectLogsItemEntriesItem' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementCollectPostBodyCollectLogsItemEntriesItem();
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementCollectPostBodyCollectLogsItemEntriesItem' => false];
    }
}
