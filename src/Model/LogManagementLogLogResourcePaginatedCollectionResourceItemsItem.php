...
class LogManagementLogLogResourcePaginatedCollectionResourceItemsItem extends ArrayObject
{
    /**
     * @var array
     */
     ...
     * The log level.
     *
     * @var LogManagementLogLogResourcePaginatedCollectionResourceItemsItemLevel
     */
    protected $level;
    /**
     ...
     * The log level.
     */
    public function getLevel(): LogManagementLogLogResourcePaginatedCollectionResourceItemsItemLevel
    {
        return $this->level;
    }
     ...
     * The log level.
     */
    public function setLevel(LogManagementLogLogResourcePaginatedCollectionResourceItemsItemLevel $level): self
    {
