...
class ResponseLogManagementGetLogCollectionOkItemsItem extends ArrayObject
{
    /**
     * @var array
     */
     ...
     * The log level.
     *
     * @var ResponseLogManagementGetLogCollectionOkItemsItemLevel
     */
    protected $level;
    /**
     ...
     * The log level.
     */
    public function getLevel(): ResponseLogManagementGetLogCollectionOkItemsItemLevel
    {
        return $this->level;
    }
     ...
     * The log level.
     */
    public function setLevel(ResponseLogManagementGetLogCollectionOkItemsItemLevel $level): self
    {
