...
class LogManagementLogEntryGetResponse200ItemsItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200ItemsItem' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200ItemsItem' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogEntryGetResponse200ItemsItem();
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200ItemsItem' => false];
    }
}
