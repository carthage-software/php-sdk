...
class LogManagementLogPostResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogPostResponse200' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogPostResponse200' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogPostResponse200();
        ...
        if (array_key_exists('level', $data)) {
            $object->setLevel($this->denormalizer->denormalize($data['level'], 'Carthage\\Sdk\\Model\\LogManagementLogPostResponse200Level', 'json', $context));
            unset($data['level']);
        }
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogPostResponse200' => false];
    }
}
