...
class LogManagementLogCollectLogEntriesItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogCollectLogEntriesItem' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogCollectLogEntriesItem' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogCollectLogEntriesItem();
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogCollectLogEntriesItem' => false];
    }
}
