...
class LogManagementLogGetResponse200ItemsItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogGetResponse200ItemsItem' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogGetResponse200ItemsItem' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogGetResponse200ItemsItem();
        ...
        if (array_key_exists('level', $data)) {
            $object->setLevel($this->denormalizer->denormalize($data['level'], 'Carthage\\Sdk\\Model\\LogManagementLogGetResponse200ItemsItemLevel', 'json', $context));
            unset($data['level']);
        }
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogGetResponse200ItemsItem' => false];
    }
}
