...
class ResponseLogManagementGetLogEntryOkNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryOk' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryOk' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\ResponseLogManagementGetLogEntryOk();
    ...
    {
        return ['Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryOk' => false];
    }
}
