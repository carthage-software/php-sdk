...
class ResponseLogManagementCreateLogOkNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\ResponseLogManagementCreateLogOk' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\ResponseLogManagementCreateLogOk' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\ResponseLogManagementCreateLogOk();
        ...
        if (array_key_exists('level', $data)) {
            $object->setLevel($this->denormalizer->denormalize($data['level'], 'Carthage\\Sdk\\Model\\ResponseLogManagementCreateLogOkLevel', 'json', $context));
            unset($data['level']);
        }
    ...
    {
        return ['Carthage\\Sdk\\Model\\ResponseLogManagementCreateLogOk' => false];
    }
}
