...
class ResponseLogManagementGetLogEntryCollectionOkNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryCollectionOk' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryCollectionOk' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\ResponseLogManagementGetLogEntryCollectionOk();
        ...
        if (array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryCollectionOkItemsItem', 'json', $context);
            }
    ...
    {
        return ['Carthage\\Sdk\\Model\\ResponseLogManagementGetLogEntryCollectionOk' => false];
    }
}
