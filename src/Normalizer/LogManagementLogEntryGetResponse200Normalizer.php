...
class LogManagementLogEntryGetResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogEntryGetResponse200();
        ...
        if (array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200ItemsItem', 'json', $context);
            }
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogEntryGetResponse200' => false];
    }
}
