...
class LogManagementLogPostResponse200 extends ArrayObject
{
    /**
     * @var array
     */
     ...
     * The log level.
     *
     * @var LogManagementLogPostResponse200Level
     */
    protected $level;
    /**
     ...
     * The log level.
     */
    public function getLevel(): LogManagementLogPostResponse200Level
    {
        return $this->level;
    }
     ...
     * The log level.
     */
    public function setLevel(LogManagementLogPostResponse200Level $level): self
    {
