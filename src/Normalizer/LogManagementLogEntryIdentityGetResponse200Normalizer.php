...
class LogManagementLogEntryIdentityGetResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogEntryIdentityGetResponse200' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogEntryIdentityGetResponse200' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogEntryIdentityGetResponse200();
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogEntryIdentityGetResponse200' => false];
    }
}
