...
class LogManagementLogLogResourcePaginatedCollectionResourceNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementLogLogResourcePaginatedCollectionResource' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementLogLogResourcePaginatedCollectionResource' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementLogLogResourcePaginatedCollectionResource();
        ...
        if (array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Carthage\\Sdk\\Model\\LogManagementLogLogResourcePaginatedCollectionResourceItemsItem', 'json', $context);
            }
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementLogLogResourcePaginatedCollectionResource' => false];
    }
}
