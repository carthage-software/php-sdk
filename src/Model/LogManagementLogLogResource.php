...
class LogManagementLogLogResource extends ArrayObject
{
    /**
     * @var array
     */
     ...
     * The log level.
     *
     * @var LogManagementLogLogResourceLevel
     */
    protected $level;
    /**
     ...
     * The log level.
     */
    public function getLevel(): LogManagementLogLogResourceLevel
    {
        return $this->level;
    }
     ...
     * The log level.
     */
    public function setLevel(LogManagementLogLogResourceLevel $level): self
    {
