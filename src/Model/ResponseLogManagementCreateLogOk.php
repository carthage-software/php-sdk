...
class ResponseLogManagementCreateLogOk extends ArrayObject
{
    /**
     * @var array
     */
     ...
     * The log level.
     *
     * @var ResponseLogManagementCreateLogOkLevel
     */
    protected $level;
    /**
     ...
     * The log level.
     */
    public function getLevel(): ResponseLogManagementCreateLogOkLevel
    {
        return $this->level;
    }
     ...
     * The log level.
     */
    public function setLevel(ResponseLogManagementCreateLogOkLevel $level): self
    {
