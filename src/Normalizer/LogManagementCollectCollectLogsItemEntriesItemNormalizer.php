...
class LogManagementCollectCollectLogsItemEntriesItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return 'Carthage\\Sdk\\Model\\LogManagementCollectCollectLogsItemEntriesItem' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Carthage\\Sdk\\Model\\LogManagementCollectCollectLogsItemEntriesItem' === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Carthage\Sdk\Model\LogManagementCollectCollectLogsItemEntriesItem();
    ...
    {
        return ['Carthage\\Sdk\\Model\\LogManagementCollectCollectLogsItemEntriesItem' => false];
    }
}
